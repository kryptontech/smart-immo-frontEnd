		...
		<div class="container mt25 offset-0">
			...
			<div class="col-md-8 pagecontainer2 space offset-0">
				...
				<div class="table-content" >
						<p class="hpadding20">
						  ...
						  votre agent-commerciale Louise jeanne au 06 33 49 70 85. BELLIS IMMO TRANSACTIONS Tél. 03 80 37 84 21 Réf. annonce : 205vs84
			...
			<div class="col-md-4" >
				...
				<div class="pagecontainer2 mt20 alsolikebox">
					...
					<div class="line5"></div> 
					<div class="container ">
						<a href="<c:url value='/detailBien'/>"><img src="resources/images/index.jpg" class="left mr20 smallimg" alt=""/></a>
						<a href="<c:url value='/detailBien'/>" class="dark"><b>Appartement</b></a><br/>
						<span class="opensans green bold size14">$125000</span> <br/>
						<span class="grey">Yopougon-Millionnaire</span>
					</div>
					<div class="line5"></div>
					<div class="container ">
						<a href="<c:url value='/detailBien'/>"><img src="resources/images/A46A0121.jpg" class="left mr20  smallimg" alt=""/></a>
						<a href="<c:url value='/detailBien'/>" class="dark"><b>Appartement</b></a><br/>
						<span class="opensans green bold size14">$125000</span> <br/>
						<span class="grey">Yopougon-Millionnaire</span>
					</div>
					<div class="line5"></div>			
					<div class="container ">
						<a href="<c:url value='/detailBien'/>"><img src="resources/images/A46B0121.jpg" class="left mr20  smallimg" alt=""/></a>
						<a href="<c:url value='/detailBien'/>" class="dark"><b>Appartement</b></a><br/>
