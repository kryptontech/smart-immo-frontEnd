			...
			<div class="col-md-12 pagecontainer2 space offset-0">
				...
				<div class="col-md-2 offset-0">
					...
					<ul class="nav profile-tabs">
						...
						<li class="active"><a href=" <c:url value='/secure/saveBien'/>"> <span
						...
						<div class="tab-pane active " id="bookings">
							<div class="padding40">
								...
								<div class="relative margtop10">
									<f:form method="POST" modelAttribute="frontPage"
										class="form-horizontal col-lg-12">
										<f:input type="hidden" value="${idFour}" path="fournisseur"
										...
										<div class=" row well">
											<div class="">
												<div class="form-group">
													...
													<div class="col-lg-4">
														<f:input type="text" path="titreBien" id="titreBien"
															class="form-control input-sm" />
													</div>
												</div>
											</div>
											<div class="">
												<div class="form-group">
													...
													<div class="col-lg-4">
														<f:input type="text" path="prixBien" id="prixBien"
															class="form-control input-sm" />
													</div>
												</div>
											</div>
											...
											<div class="">
												<div class="form-group">
													...
													<div class="col-lg-4">
														<f:select path="souscategorie" class="form-control"
															items="${listSousCategorie}">
														</f:select>
										...
										<div class=" row well">
											...
											<div class="">
												<div class="form-group">
													...
													<div class="col-lg-4">
														<f:select path="ville" class="form-control"
															items="${listVille}">
														</f:select>
											...
											<div class="">
												<div class="form-group">
													...
													<div class="col-lg-4">
														<f:input type="text" path="quartierBien" id="quartierBien"
															class="form-control" />
													</div>
												</div>
											</div>
											...
											<div class="">
												<div class="form-group">
													...
													<div class="input-group col-lg-4">
														<f:input type="number" path="superficieBien"
															id="superficieBien" class="form-control " />
										...
										<div class=" row well">
											<div class="">
												<div class="form-group">
													...
													<div class="col-lg-4">
														<f:input type="number" path="nbPieceBien" id="nbPieceBien"
															class="form-control " />
											...
											<div class="">
												<div class="form-group">
													<label class="col-lg-3">Entrer une description pour
														votre bien:</label>
													<div class="col-lg-4">
														<f:textarea type="text" path="descriptionBien"
															id="descriptionBien" class="form-control "></f:textarea>
											...
											<div class="">
												<div class="form-group">
													...
													<div class="col-lg-4">
														<f:select path="disponibilite" class="form-control "
															items="${listDisponibilite}">
														</f:select>
